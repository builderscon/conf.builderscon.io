...
{%- if dates|length > 0 %}
[{%- for x in dates -%}
{%- set dt = x|confdate(lang=lang,timezone=conference.get('timezone')) %}
{{ dt.date() }}{% if not loop.last %},{% endif %}
{%- endfor -%}]
{%- endif %}
{%- endwith %}
            </p>
...
{% endif %}
  ...
  {% set technical_sponsors = [
      dict(
          ...
          group_name = 'tier-1',
          url = 'https://clubt.jp',
          logo_url = 'https://storage.googleapis.com/media-builderscon-1248/system/clubT-600x600.png'
      ),
      dict(
          name = 'Google Cloud Platform',
          group_name = 'tier-1',
          url = 'https://cloud.google.com/',
          logo_url = 'https://storage.googleapis.com/media-builderscon-1248/system/gcp-600x600.png'
      ),
      dict(
          name = 'GitHub',
          group_name = 'tier-1',
          url = 'https://github.com/',
          logo_url = 'https://storage.googleapis.com/media-builderscon-1248/system/github-600x600.png'
      ),
      dict(
          name = 'Mackerel',
          group_name = 'tier-1',
          url = 'https://mackerel.io',
          logo_url = 'https://storage.googleapis.com/media-builderscon-1248/system/mackerel-600x600.png'
      )
  ] %}
